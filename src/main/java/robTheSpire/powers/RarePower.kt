...
import robTheSpire.cards.defaultExampleCards.DefaultRareAttack
import robTheSpire.util.TextureLoader

class RarePower(owner: AbstractCreature?, source: AbstractCreature, amount: Int) : AbstractPower(), CloneablePowerInterface {
    var source: AbstractCreature
    override fun atStartOfTurn() { // At the start of your turn
        val playCard: AbstractCard = DefaultRareAttack() // Declare Card - the DefaultRareAttack card. We will name it 'playCard'.
        val targetMonster = AbstractDungeon.getRandomMonster() // Declare Target - Random Monster. We will name the monster 'targetMonster'.
        ...
        AbstractDungeon.actionManager.addToBottom(QueueCardAction(playCard, targetMonster)) // Play the card on the target.
    }
    ...
    companion object {
        val POWER_ID = makeID("RarePower")
        private val powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID)
        val NAME = powerStrings.NAME
        val DESCRIPTIONS = powerStrings.DESCRIPTIONS

        // We create 2 new textures *Using This Specific Texture Loader* - an 84x84 image and a 32x32 one.
        private val tex84 = TextureLoader.getTexture("robTheSpireResources/images/powers/placeholder_power84.png")
        private val tex32 = TextureLoader.getTexture("robTheSpireResources/images/powers/placeholder_power32.png")
    }
