...
object DefaultInsertPatch {
    ...
    private val logger = LogManager.getLogger(DefaultInsertPatch::class.java.name) // This is our logger! It prints stuff out in the console.

    // It's like a very fancy System.out.println();
    @SpireInsertPatch(locator = Locator::class, localvars = ["retVal"]) //"A patch method must be a public static method."
