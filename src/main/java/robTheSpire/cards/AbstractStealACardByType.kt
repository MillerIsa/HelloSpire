...
abstract class AbstractStealACardByType @JvmOverloads constructor(theType: CardType, ID: String?, cardStrings: CardStrings, rarity: CardRarity? = CardRarity.COMMON) : AbstractDefaultCard(ID, cardStrings.NAME, makeCardPath("StealACard.png"), 2, cardStrings.DESCRIPTION, CardType.SKILL, COLOR_GRAY, rarity, CardTarget.SELF) {
