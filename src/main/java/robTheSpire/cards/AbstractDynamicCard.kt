...
(id: String?,
 ...
 color: CardColor?,
 rarity: CardRarity?,
 target: CardTarget?) : AbstractDefaultCard(id, CardCrawlGame.languagePack.getCardStrings(id).NAME, img, cost, CardCrawlGame.languagePack.getCardStrings(id).DESCRIPTION, type, color, rarity, target)