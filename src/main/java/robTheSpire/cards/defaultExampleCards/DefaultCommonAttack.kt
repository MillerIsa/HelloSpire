...
class DefaultCommonAttack : CustomCard(ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET) {
    ...
    override fun use(p: AbstractPlayer, m: AbstractMonster?) {
        AbstractDungeon.actionManager.addToBottom( // The action managed queues all the actions a card should do.
                ...
                DamageAction(m, DamageInfo(p, damage, damageTypeForTurn),  // a list of existing actions can be found at com.megacrit.cardcrawl.actions but
     ...
     */
        // TEXT DECLARATION
        val ID = makeID(DefaultCommonAttack::class.java.simpleName)
    ...
    init {
        ...
        baseDamage = DAMAGE
        tags.add(BaseModCardTags.BASIC_STRIKE) //Tag your strike, defend and form (Wraith form, Demon form, Echo form, etc.) cards so that they function correctly.
